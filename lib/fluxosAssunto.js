...
// Texto da etapa "descricao". Sem config própria, ela é opcional quando o assunto já coleta
// produtos (o resumo deles já é o conteúdo do chamado) e obrigatória nos demais.
const MOTIVO_DEVOLUCAO = {
  titulo: 'Qual o motivo da devolução?',
  ajuda: 'Conte por que a mercadoria está sendo devolvida.',
  rotulo: 'Motivo da devolução',
  rotuloNoChamado: 'Motivo da devolução',
  obrigatoria: true,
};
...
const FLUXOS = {
  ...
  35: {
    ...
    descricao: MOTIVO_DEVOLUCAO,
  },

  // DEVOLUÇÃO INTEGRAL - sem seleção de itens: todos os itens da nota vão no chamado
  23: {
  ...
  // FALTA DE VOLUME NA ENTREGA
  38: {
    steps: ['produtos_qt', 'data', 'anexos', 'descricao', 'contato'],
    produtos: {
      modo: 'quantidade',
      titulo: 'Quais produtos estavam no volume que faltou?',
      ajuda: 'Marque os itens que não chegaram e informe as quantidades.',
      rotuloCampo: 'Quantidade que faltou:',
    },
  },
